            ...
            <div class="row">
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                  <div class="inner">
                    ...
                    <p>Data Penjualan Tiket Langsung</p>
                  </div>
                  <div class="icon">
                    <i class="nav-icon fa fa-fw fa-ticket fa-lg" style="padding-top:30px;"></i>
                  </div>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                  ...
                  <div class="icon">
                    <i class="fa fa-fw fa-qrcode fa-sm " style="padding-top:30px;"></i>
                  </div>
                  <a href="#" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                  ...
                  <div class="icon">
                    <i class="fa fa-fw fa-file fa-sm" style="padding-top:30px;"></i>
                  </div>
                  <a href="#" class="small-box-footer">Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
