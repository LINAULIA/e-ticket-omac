            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a style="color:black;" href="<?= base_url('wahana'); ?>">Wahana</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#modaltambahwahana"><i class="fas fa-plus fa-fw"></i>Tambah Data Baru</button>
                    ...
                    <tbody>
                        ...
                        foreach ($wahana as $s) { ?>
                            <tr>
                                ...
                                <td><?= $s->keterangan ?></td>
                                <td>
                                    <a href="<?= base_url('wahana/update') . '/' . $s->id_wahana; ?>" class="btn btn-warning btn-sm">Edit</a>

                                    <?php echo anchor('wahana/delete/' . $s->id_wahana, '<div class="btn btn-sm btn-danger btn-sm"><i class="fas fa-trash"></i></div>') ?>
                                </td>
                            </tr>
                        <?php } ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-info">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLongTitle">Tambah Data Wahana</h4>
